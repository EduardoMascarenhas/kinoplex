...
// Fun̤̣o para obter o texto do tipo de convite
                        ...
                        {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                            ...
                            return (
                                <TableRow
                                    ...
                                    tabIndex={-1}
                                    key={row.id} // Usar id ̼nico da Oportunidade
                                                ...
                                                <Tooltip
                                                    title={
                                                        quantidadeImpresso && quantidadeEletronico
                                                            ? `Impressos: ${quantidadeImpresso}, Eletr̫nicos: ${quantidadeEletronico}`
                                                            : quantidadeImpresso
                                                              ? `Impressos: ${quantidadeImpresso}`
                                                              : `Eletr̫nicos: ${quantidadeEletronico}`
                                                    }
                                                >
