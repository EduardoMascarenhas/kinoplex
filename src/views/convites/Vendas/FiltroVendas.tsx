        ...
        return (
            <Grid container spacing={2}>
                {columns.map((column, columnIndex) => (
                    <Grid item key={columnIndex} xs={4}>
                        {' '}
                        {/* xs={6} deixa 2 colunas na linha */}
                        {column.map((item) => (
                            <CustomTreeItem
                                key={item.value}
                                itemId={item.value}
        ...
        <Grid container spacing={1}>
            <Grid container xs={12} md={7} spacing={1}>
                ...
                <Grid item xs={12} md={6}>
                    ...
                    <IconButtonCheckbox color="primary" size="small" disableRipple aria-label="live customize" onClick={handleClick}>
                    ...
                    >
                        <Grid container spacing={0}>
                            <Grid item xs={12} md={7} display="flex" flexDirection="column">
                                ...
                                <FormControlLabel
                                    value="Confirmadas/Pagas"
                                    control={<Radio sx={{ pb: '2px', pt: '2px' }} />}
                                    label="Confirmadas/Pagas"
                                />
                                <FormControlLabel
                                    value="Sem confirmação de pagamento"
                                    control={<Radio sx={{ pb: '2px', pt: '2px' }} />}
                                    label="Sem confirmação de pagamento"
                                />
            ...
            <Grid item xs={12} display="flex" justifyContent="flex-end">
                <Button variant="contained" onClick={applyFilters} color="primary" endIcon={<SearchIcon />}>
                    Pesquisar
                </Button>
            </Grid>
        </Grid>
